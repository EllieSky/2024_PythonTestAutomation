...
person2.do_work(8)
print('person 2: ', "Initial Steve's stuff is: ", person2.stuff)
person2.report_net_worth()

person2.buy_something({'item': 'toy car', 'price': 40.99})
print("Steve's stuff ", person2.stuff)
print(f"Steve's net_worth :{person2.net_worth:.2f}")

person2.sell_something({'item': 'hat', 'price': 14.59})
print("Steve's stuff ", person2.stuff)
print(f"Steve's net_worth: {person2.net_worth:.2f}")
...
person1.do_work(4)
print('person 1: ', "Initial Maria's stuff is: ", person1.stuff)
person1.report_net_worth()

person1.buy_something({'item': 'shoes', 'price': 400.99})
print("Maria's stuff ", person1.stuff)
print(f"Maria's net_worth: {person1.net_worth:.2f}")

person1.sell_something({'item': 'book', 'price': 24.00})
print("Maria's stuff ", person1.stuff)
print(f"Maria's net_worth: {person1.net_worth:.2f}")
