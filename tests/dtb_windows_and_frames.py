...
class WindowsAndFrames(BrowserFixture):
    ...
    def test_with_frames(self):
        ...
        page_header = self.browser.find_elements(By.CSS_SELECTOR, '#framesWrapper>h1')
        self.assertEquals('Nested Frames', page_header)

        self.browser.switch_to.frame(self.browser.find_elements(By.ID, 'frame1'))
