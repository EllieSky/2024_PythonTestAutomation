...
class UpdatePersonalDetails(AdminLoginFixture):
    def test_update_info_and_job(self):
        ...
        self.employee_list.view_record(row=1)
        self.personal_details.edit()
        self.personal_details.update_info(middle_name = middle_name, ssn = ssn, mar_status = marital_status)
        ...
        self.login_page.aunthenticate('bobboss', 'bobboss')
